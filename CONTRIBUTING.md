...
Keep technical-branch commits focused enough to diagnose CI failures. A completed vertical stage may be squash-promoted to `main` only after the exact branch tree passes all required gates. Do not force-update `main` for normal stage promotion.
