...
dispatcher tenta novamente. A consulta da fila filtra PENDING antes de limitar a rodada a
2.000 IDs, em ordem de criação; o tamanho do histórico concluído não oculta pendências antigas.
